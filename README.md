...
[![AppVeyor build
status](https://ci.appveyor.com/api/projects/status/github/RRMaximiliano/constitucionesNic?branch=master&svg=true)](https://ci.appveyor.com/project/RRMaximiliano/constitucionesNic)
<!-- badges: end -->
